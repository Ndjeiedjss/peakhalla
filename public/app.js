...
function renderLeaderboardRows(rankings = []) {
  ...
  const rankScope = activeRegion === 'ALL' ? 'WLD' : activeRegion;
  const rankScopeTitle = activeRegion === 'ALL' ? t('globalRank') : `${t('regionRank')} · ${regionLabel(activeRegion)}`;
