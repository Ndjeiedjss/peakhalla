...
app.get('/api/clans/:id', async (req, res, next) => {
  try {
    ...
    const resolvedLifetimeXp = maxPositiveNumber(candidateGuild.xp, currentRosterXp, officialRosterXp);
