...
const translations = {
  en: {
    ...
    playerSummary: 'Player summary', knownNames: 'Known names', knownNamesNote: 'Previous names are shown only when PeakHalla has observed them from official Brawlhalla responses.',
    ...
    accountLevel: 'Account level', accountXP: 'Account XP', xpProgress: 'XP progress', gameTime: 'Online match time', mainWeapons: 'Main weapons', topLegends: 'Main legends', regionRank: 'Region rank', totalGames: 'Total games', totalWins: 'Total wins', overallWinRate: 'Overall win rate', liveOfficialData: 'Live player data', corehallaStats: 'PeakHalla official-data cache', currentAlias: 'Current name', previousAliases: 'Previous names', refreshLiveStats: 'Refresh live stats', refreshingLiveStats: 'Refreshing official stats…', notReported: 'Not reported by API', statsAccuracyNote: 'Account XP and legend levels come from the official Brawlhalla API. PeakHalla caches the latest official response for faster loading.', legendLevelLimit: 'Some legend XP and levels may be unavailable if that legend has not been played since Patch 9.07.',
  ...
  ar: {
    ...
    playerSummary: 'زبدة الحساب', knownNames: 'الأسماء المعروفة', knownNamesNote: 'تظهر الأسماء السابقة فقط إذا رصدها PeakHalla سابقًا من استجابات Brawlhalla الرسمية.',
...
function makePlayerSeedPayload(item = {}, player = {}) {
  ...
  return {
    ...
    player: {
      ...
      data_quality: { source: 'Instant search preview · live stats loading', corehalla_enriched: false, official_only: true, live_fetch: false },
